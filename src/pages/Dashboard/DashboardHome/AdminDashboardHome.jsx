...
import { ShieldUser, Tickets, Users, Megaphone, Home, BarChart3, Sun, Moon, Menu, X, LogOut } from "lucide-react";
...
const AdminDashboardHome = () => {
  ...
  const navicon = [BarChart3, ShieldUser, Tickets, Users, Megaphone];
  const navtext = [
    "Overview",
    "Profile",
    "Manage Ticket",
      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden relative">
        <header className="h-20 bg-gray-50 dark:bg-gray-900 flex items-center justify-between px-4 lg:px-8 shrink-0 border-b border-gray-200 dark:border-gray-700">
          <div className="flex items-center">
            ...
            <h2 className="text-xl lg:text-2xl font-bold text-gray-800 dark:text-white">Admin Dashboard</h2>
          </div>
